...
// Biến phục vụ cho hàm millis()
unsigned long previousMillis = 0;
bool isAtMaxAngle = false; // Trạng thái hiện tại của Servo (đang ở 0 hay đang ở góc max)
...
<body>
  <h2>ESP32 - CẢM BIẾN ÁNH SÁNG & SERVO</h2>
  <hr>
  <p><b>Giá trị cảm biến (LDR):</b> <span id='ldrValue'>0</span></p>
...
void handleStatus() {
  ...
  String json = "{\"ldr\":\"" + String(ldrVal) + "\", \"motor\":\"" + state + "\"}";
